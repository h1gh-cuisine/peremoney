...
export interface ApiPayment { id: string; invoiceNo?: string; amount: string | number; unitPrice?: string | number; quantity: number; status: 'PAID' | 'PENDING'; invoiceCreationStatus?: 'PENDING' | 'SUCCEEDED' | 'FAILED' | 'UNCERTAIN'; createdAt: string; tochkaDocumentId?: string | null; }
